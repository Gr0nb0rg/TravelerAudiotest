...
public class ControllerClimbing : MonoBehaviour {
    ...
    {
        Vector3 endpointR = ((m_climbRaycheckR.forward.normalized * m_climbCheckRayDist) + m_climbRaycheckR.position);
        Vector3 endpointL = ((m_climbRaycheckL.forward.normalized * m_climbCheckRayDist) + m_climbRaycheckL.position);
